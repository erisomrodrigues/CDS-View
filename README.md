...
5.  Cds com [asssociation entre 4 tabelas](CDS_View/SAP_Technomaniac), porém ao usar _$projection_ em uma das tabelas, não permite exibir coluna de descrição. Sendo necessário [criar outra CDS](CDS_View/SAP_Technomaniac) para consumir e exibir. 
